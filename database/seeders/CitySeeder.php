...
class CitySeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::table('cities')->delete(); // obrisi podatke iz tablice
        DB::table('cities')->insert($city); // ubaci podatke 
        DB::table('cities')->update(['created_at' => Carbon::now()]);  //MOŽE !!
       // DB::table('countries')->update(['updated_at' => Carbon::now()]);  //MOŽE !!
